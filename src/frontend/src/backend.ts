...
import type { ExternalBlob as _ExternalBlob, StripeSessionStatus as _StripeSessionStatus, StudyMaterial as _StudyMaterial, StudyMaterialPublic as _StudyMaterialPublic, Time as _Time, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getMaterial(arg0: string): Promise<StudyMaterialPublic | null> {
        if (this.processError) {
            try {
    ...
    async getMaterialBlobId(arg0: string): Promise<ExternalBlob | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getMaterialBlobId(arg0);
    ...
    async getMaterialsBySubject(arg0: string): Promise<Array<StudyMaterialPublic>> {
        if (this.processError) {
            try {
    ...
    async getUserPurchases(): Promise<Array<PurchaseRecord>> {
        if (this.processError) {
            try {
    ...
    async listMaterials(arg0: boolean): Promise<Array<StudyMaterialPublic>> {
        if (this.processError) {
            try {
    ...
    async recordPurchase(arg0: PurchaseRecord): Promise<void> {
        if (this.processError) {
            try {
    ...
    async searchMaterials(arg0: string): Promise<Array<StudyMaterialPublic>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchMaterials(arg0);
                return from_candid_vec_n17(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadMaterial(arg0: StudyMaterial): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadMaterial(await to_candid_StudyMaterial_n22(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_StudyMaterialPublic_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _StudyMaterialPublic): Promise<StudyMaterialPublic> {
...
async function from_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_StudyMaterialPublic]): Promise<StudyMaterialPublic | null> {
    return value.length === 0 ? null : await from_candid_StudyMaterialPublic_n13(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_StudyMaterialPublic>): Promise<Array<StudyMaterialPublic>> {
    return await Promise.all(value.map(async (x)=>await from_candid_StudyMaterialPublic_n13(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_StudyMaterial_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: StudyMaterial): Promise<_StudyMaterial> {
...
async function to_candid_record_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        description: value.description,
        subjectId: value.subjectId,
        blobId: await to_candid_ExternalBlob_n24(_uploadFile, _downloadFile, value.blobId),
        uploader: value.uploader,
        downloadCount: value.downloadCount
    };
}
